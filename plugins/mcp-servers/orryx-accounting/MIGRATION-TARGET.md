...
This service-domain MCP is currently staged in orryx-knowledge/plugins/mcp-servers/orryx-accounting/ for review.

**Production target:** `D:\orryx-accounting`
...
**Status:** STAGED. Domain: accounting. Port: 9007.