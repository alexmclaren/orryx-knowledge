...
This service-domain MCP is currently staged in orryx-knowledge/plugins/mcp-servers/orryx-risk-compliance/ for review.

**Production target:** `D:\orryx-risk-compliance`
...
**Status:** STAGED. Domain: risk-compliance. Port: 9001.