...
This service-domain MCP is currently staged in orryx-knowledge/plugins/mcp-servers/orryx-security/ for review.

**Production target:** `D:\orryx-security`
...
**Status:** STAGED. Domain: security. Port: 9002.