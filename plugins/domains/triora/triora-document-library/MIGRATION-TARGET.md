...
**Production target:** `D:\Clinical.Trials\.claude-plugin\triora-document-library\`
...
3. Remove the local copy from `orryx-knowledge/plugins/domains/triora/triora-document-library/`

Entity: **triora**
Owning repo: **D:\Clinical.Trials**
Plugin: **triora-document-library**