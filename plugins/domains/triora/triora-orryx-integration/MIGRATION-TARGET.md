...
**Production target:** `D:\Clinical.Trials\.claude-plugin\triora-orryx-integration\`
...
3. Remove the local copy from `orryx-knowledge/plugins/domains/triora/triora-orryx-integration/`

Entity: **triora**
Owning repo: **D:\Clinical.Trials**
Plugin: **triora-orryx-integration**