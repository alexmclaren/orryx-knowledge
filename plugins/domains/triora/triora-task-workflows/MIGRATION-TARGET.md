...
**Production target:** `D:\Clinical.Trials\.claude-plugin\triora-task-workflows\`
...
3. Remove the local copy from `orryx-knowledge/plugins/domains/triora/triora-task-workflows/`

Entity: **triora**
Owning repo: **D:\Clinical.Trials**
Plugin: **triora-task-workflows**