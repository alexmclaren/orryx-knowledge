...
**Production target:** `D:\Clinical.Trials\.claude-plugin\triora-healthcare-context\`
...
3. Remove the local copy from `orryx-knowledge/plugins/domains/triora/triora-healthcare-context/`

Entity: **triora**
Owning repo: **D:\Clinical.Trials**
Plugin: **triora-healthcare-context**