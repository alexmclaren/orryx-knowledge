...
**Production target:** `D:\pillarworks-build-mvp\.claude-plugin\pillarworks-domain-check\`
...
3. Remove the local copy from `orryx-knowledge/plugins/domains/pillarworks/pillarworks-domain-check/`

Entity: **pillarworks**
Owning repo: **D:\pillarworks-build-mvp**
Plugin: **pillarworks-domain-check**