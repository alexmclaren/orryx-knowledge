...
**Production target:** `D:\orryx-flow\.claude-plugin\flow-tenant-security\`
...
3. Remove the local copy from `orryx-knowledge/plugins/domains/flow/flow-tenant-security/`

Entity: **flow**
Owning repo: **D:\orryx-flow**
Plugin: **flow-tenant-security**